(function () {
  ...
  function initializeUploadsUI() {
    applyFiltersPanelState();
    bindUploadModals();
  }

  document.addEventListener("DOMContentLoaded", initializeUploadsUI);
  document.body.addEventListener("htmx:afterSwap", initializeUploadsUI);
  document.body.addEventListener("htmx:load", initializeUploadsUI);
})();
