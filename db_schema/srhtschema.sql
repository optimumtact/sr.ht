...
--
-- Name: task_schedule; Type: TABLE; Schema: public; Owner: -
--
...
--
-- Name: task_schedule_id_seq; Type: SEQUENCE; Schema: public; Owner: -
--

CREATE SEQUENCE public.task_schedule_id_seq
    AS integer
    START WITH 1
    INCREMENT BY 1
    NO MINVALUE
...
--
-- Name: task_schedule_id_seq; Type: SEQUENCE OWNED BY; Schema: public; Owner: -
--
...
--
-- Name: task_schedule id; Type: DEFAULT; Schema: public; Owner: -
--
...
--
-- Name: task_schedule task_schedule_pkey; Type: CONSTRAINT; Schema: public; Owner: -
--
...
--
-- Name: ix_task_schedule_next_run_time; Type: INDEX; Schema: public; Owner: -
--

CREATE INDEX IF NOT EXISTS ix_task_schedule_next_run_time ON public.task_schedule USING btree (next_run_time);
